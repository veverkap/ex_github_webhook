defmodule ExGithubWebhook.Factory do
  ...
  def app_factory do
    %{
      ...
      "description" => "",
      "events" => ["delete", "pull_request", "push"],
  ...
  def author_factory do
    %{"email" => "lukeghenco@gmail.com", "name" => "lukeghenco"}
  end
  ...
  def check_run_event_factory do
    %{
      "action" => "completed",
  ...
  def check_run_factory do
    %{
      ...
      "conclusion" => "neutral",
      "details_url" =>
        "https://app.netlify.com/sites/fs5-staging/deploys/5cd4e97266b8b3000c5b0c4c",
  ...
  def check_suite_event_factory do
    %{
      "action" => "completed",
      "check_suite" => build(:check_suite),
      "organization" => build(:organization),
  ...
  def commit_comment_event_factory do
    %{
      "action" => "created",
  ...
  def content_reference_event_factory do
    %{
      "action" => "created",
      "content_reference" => build(:content_reference),
  ...
  def deploy_key_event_factory do
    %{
      "action" => "created",
      "key" => build(:key),
      "organization" => build(:organization),
  ...
  def deployment_event_factory do
    %{
  ...
  def deployment_status_event_factory do
    %{
      "deployment" => build(:deployment),
      "deployment_status" => build(:deployment_status),
      "repository" => build(:repository),
      "sender" => build(:sender)
    }
  end
  ...
  def deployment_status_factory do
    %{
      ...
      "creator" => build(:creator),
      "deployment_url" =>
        "https://api.github.com/repos/Codertocat/Hello-World/deployments/87972451",
      "description" => "",
      "id" => 131_924_804,
  ...
  def forkee_factory do
    %{
      ...
      "issue_comment_url" =>
        "https://api.github.com/repos/github/webhook/issues/comments{/number}",
      "watchers" => 0,
      "disabled" => false,
      "mirror_url" => nil,
      ...
      "collaborators_url" =>
        "https://api.github.com/repos/github/webhook/collaborators{/collaborator}",
      "watchers_count" => 0,
      "archived" => false,
  ...
  def github_app_authorization_event_factory do
    %{"action" => "revoked", "sender" => build(:sender)}
  end

  def gollum_event_factory do
    %{
      "organization" => build(:organization),
      "pages" => [
        %{
  ...
  def installation_event_factory do
    %{
      "action" => "deleted",
      "installation" => build(:installation),
      "repositories" => [
  ...
  def installation_factory do
    %{"id" => 371_641, "node_id" => "MDIzOkludGVncmF0aW9uSW5zdGFsbGF0aW9uMzcxNjQx"}
  end

  def installation_repositories_event_factory do
    %{
      "action" => "removed",
      "installation" => build(:installation),
      "repositories_added" => [],
  ...
  def issue_comment_event_factory do
    %{
      "action" => "created",
      "comment" => build(:comment),
      "issue" => build(:issue),
  ...
  def marketplace_purchase_event_factory do
    %{
      "action" => "purchased",
      "effective_date" => "2017-10-25T00:00:00+00:00",
      "marketplace_purchase" => build(:marketplace_purchase),
      "sender" => build(:sender)
    }
  end
  ...
  def membership_event_factory do
    %{
      "action" => "added",
      "member" => build(:member),
      "organization" => build(:organization),
  ...
  def membership_factory do
    %{
      "organization_url" => "https://api.github.com/orgs/PushComedyTheater",
      "role" => "member",
      "state" => "pending",
      "url" => "https://api.github.com/orgs/PushComedyTheater/memberships/fis-bot",
      "user" => build(:user)
    }
  end

  def meta_event_factory do
    %{
      "action" => "deleted",
      "hook" => build(:hook),
      "hook_id" => 109_067_278,
  ...
  def milestone_event_factory do
    %{
      "action" => "created",
  ...
  def org_block_event_factory do
    %{
      "action" => "blocked",
  ...
  def organization_event_factory do
    %{
      "action" => "member_added",
  ...
  def page_build_event_factory do
    %{
      "build" => build(:build),
      "id" => 130_072_952,
      "organization" => build(:organization),
  ...
  def project_card_event_factory do
    %{
      "action" => "created",
      "organization" => build(:organization),
      "project_card" => build(:project_card),
      "repository" => build(:repository),
      "sender" => build(:sender)
    }
  end
  ...
  def project_column_event_factory do
    %{
      "action" => "created",
      "organization" => build(:organization),
      "project_column" => build(:project_column),
      "repository" => build(:repository),
      "sender" => build(:sender)
    }
  end
  ...
  def pull_request_event_factory do
    %{
      "action" => "opened",
      "number" => 212,
      "organization" => build(:organization),
  ...
  def pull_request_factory do
    %{
      ...
      "commits" => 1,
      "review_comment_url" =>
        "https://api.github.com/repos/github/webook-v5/pulls/comments{/number}",
  ...
  def pull_request_review_comment_event_factory do
    %{
      "action" => "created",
      "comment" => build(:comment),
      "pull_request" => build(:pull_request),
  ...
  def pull_request_review_event_factory do
    %{
      "action" => "submitted",
      "organization" => build(:organization),
      "pull_request" => build(:pull_request),
    ...
    %{
      ...
      "commits" => [
        %{
          ...
          "url" =>
            "https://github.com/github/webhook/commit/80a91bcbf98c0aaf82ad958a8090c6b8828fdf1d"
        }
      ],
  ...
  def registry_package_event_factory do
    %{"event" => "registry_package", "payload" => build(:payload)}
  end
  ...
  def repo_factory do
    %{
      ...
      "issue_comment_url" =>
        "https://api.github.com/repos/github/webook-v5/issues/comments{/number}",
      "watchers" => 3,
      "disabled" => false,
      "mirror_url" => nil,
      ...
      "issue_events_url" =>
        "https://api.github.com/repos/github/webook-v5/issues/events{/number}",
      "notifications_url" =>
  ...
  def repository_import_event_factory do
    %{
      "organization" => build(:organization),
      "repository" => build(:repository),
      "sender" => build(:sender),
  ...
  def repository_vulnerability_alert_event_factory do
    %{"action" => "dismiss", "alert" => build(:alert)}
  end
  ...
  def security_advisory_event_factory do
    %{"action" => "published", "security_advisory" => build(:security_advisory)}
  end
